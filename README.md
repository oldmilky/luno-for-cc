...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/VSIX-589%20kB-555" alt="VSIX size: 589 kB" />
</p>
...
- 📦 **Runs your own CLI.** No bundled copy: LUNO finds the `claude` binary on your
  PATH (or in the standard install locations) and drives that. The VSIX is 589 kB,
...
- `bun run lint` typechecks **both** projects and `bun run test` must stay green
  (357 pass / 6 skipped; the skips are filesystem-gated, not broken).
