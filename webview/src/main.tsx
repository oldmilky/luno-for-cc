...
// as a dismissal, it just stops moving. The CSS side has honoured
// `prefers-reduced-motion` since Ф1; framer did not, which meant the setting
// silently turned off half the app's motion and left the other half running.
// One place, because both shells mount through this entry.
root.render(
  <StrictMode>
